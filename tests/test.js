...
ok($("#mathPortal").href === "https://nevergiveup0618.github.io/Math/?v=2", "数学入口指向数学奇境");
ok($("#mathToday").textContent.includes("做对 5 题"), "数学显示今天做对题数（不设打卡）");
ok($("#mathAction").textContent.includes("继续穿越数学史"), "已收集奇观时给出继续文案");
ok($("#mathProgress").style.width === "40%", "数学进度按已收集奇观 2/5 计算");
...
ok(fs.readFileSync(path.join(ROOT,"sw.js"),"utf8").includes("learning-planet-v9"), "缓存号已升级");
