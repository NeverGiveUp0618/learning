...
ok($("#englishPortal").href === "https://nevergiveup0618.github.io/English/?v=64", "英语入口指向当前缓存版本");
ok($("#chinesePortal").href === "https://nevergiveup0618.github.io/Chinese/?v=41", "语文入口指向当前缓存版本");
...
ok($("#mathPortal").href === "https://nevergiveup0618.github.io/Math/?v=14", "数学入口指向数学奇境当前缓存版本");
...
ok(fs.readFileSync(path.join(ROOT,"sw.js"),"utf8").includes("learning-planet-v13"), "缓存号已升级");
