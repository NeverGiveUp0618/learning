...
ok($("#chinesePortal").href === "https://nevergiveup0618.github.io/Chinese/?v=42", "语文入口指向当前缓存版本");
...
ok(fs.readFileSync(path.join(ROOT,"sw.js"),"utf8").includes("learning-planet-v15"), "缓存号已升级");
